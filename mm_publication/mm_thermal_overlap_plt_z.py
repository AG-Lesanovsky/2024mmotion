...
# Scatter plot
nS_trans = ax.scatter(dx_values_filtered, E_values_filtered, c=nS_values_filtered, cmap='bone_r', s=5, rasterized=True, vmin=0, vmax=1, label = r'$\langle N \rangle = 0.1, T = 0.42$')
...
plt.text(5, -30000, r'(b) $\delta = 100$', fontsize = 24)
